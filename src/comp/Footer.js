            ...
            <footer className="px-4   text-gray-400">
                <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
                    <div className="flex flex-row pr-3 space-x-4 sm:space-x-8">
                                    ...
                                    <div className="flex flex-col justify-center space-y-3">
                                        ...
                                        <div className="space-y-1">
                                            <span className="flex items-center space-x-2">
                                                ...
                                                <span className="dark:text-gray-400">sit19it009@sairamtap.edu.in</span>
                                            </span>
                                            <span className="flex items-center space-x-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Phonenumber" className="w-4 h-4">
                                                    <path fill="currentColor" d="M449.366,89.648l-.685-.428L362.088,46.559,268.625,171.176l43,57.337a88.529,88.529,0,0,1-83.115,83.114l-57.336-43L46.558,362.088l42.306,85.869.356.725.429.684a25.085,25.085,0,0,0,21.393,11.857h22.344A327.836,327.836,0,0,0,461.222,133.386V111.041A25.084,25.084,0,0,0,449.366,89.648Zm-20.144,43.738c0,163.125-132.712,295.837-295.836,295.837h-18.08L87,371.76l84.18-63.135,46.867,35.149h5.333a120.535,120.535,0,0,0,120.4-120.4v-5.333l-35.149-46.866L371.759,87l57.463,28.311Z"></path>
                        ...
                        <div class="px-40">
                            <img class="bg-gray-900 px-36 py-4" src={Location} height={350} width={350} alt="" /><br/>
                            <text class="text-2xl font-nunito font-bold text-white">Sri Sairam Institute of Technology</text><br />
                            <text class="text-xl font-nunito font-bold text-white">Sai Leo Nagar, West Tambaram,
                                <br />Chennai - 600044</text>
