    ...
    <div class="py-16 bg-slate-900">
      <footer className="px-4   text-gray-400">
        <div className="container  flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
            ...
            <ul className="flex flex-wrap items-center space-x-4 sm:space-x-8">
              <li>
                <div className="max-w-md px-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100">
                  <div className="flex flex-col justify-center space-y-3  w-64">
                    <div>
          ...
          <center>
            <ul className="flex flex-wrap pl-3 space-x-4 sm:space-x-8 mt-5 ml-10">
              <li>
