        ...
        <div id="schedule">
            <section className="bg-black text-gray-400">
                <div className="container mx-auto flex flex-col p-6">
                    <h2 className="py-4 text-3xl font-bold text-center">Event Schedule</h2>
                    <div className="divide-y divide-gray-700">
                        ...
                        <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                            ...
                            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                                <span className="text-xs tracking-wider uppercase dark:text-violet-400">Phase 2</span>
                                <span className="text-xl font-bold md:text-2xl">Shortlisting</span>
                                <span className="mt-4 dark:text-gray-300">Shortlisted Results Date:TBA</span>
                            </div>
                        </div>
                        <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                            <div className="flex items-center justify-center lg:col-span-1 col-span-full">
                            ...
                            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                                <span className="text-xs tracking-wider uppercase dark:text-violet-400">Phase 3</span>
                                <span className="text-xl font-bold md:text-2xl">Hackathon</span>
                                <span className="mt-4 font-nunito dark:bg-gray-800 dark:text-gray-300">October 19 10.00 A.M ~ October 20 10.00 A.M</span>
                            </div>
                        </div>
                        <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                            <div className="flex items-center justify-center lg:col-span-1 col-span-full">
