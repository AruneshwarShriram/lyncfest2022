    ...
    <div id="domains" class="bg-black px-5 py-28">
            ...
            <div class="flex justify-center">
                <div class="rounded-lg shadow-lg bg-slate-800 max-w-sm">
                    ...
                    <div class="p-6">
                        {/*<h5 class="text-gray-900 text-xl font-medium mb-2">Card title</h5>*/}
                            <a href="hackathon/PS#BC"><button type="button" class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-base leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Blockchain</button>
                    </a>
                            </div>
                </div>
            </div>
