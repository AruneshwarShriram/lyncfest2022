                ...
                <header class="max-w-full md:w-1/2 mx-auto">
                    <div class="relative flex flex-col justify-center items-center space-y-3 mx-10">
                        ...
                        <svg viewBox="0 0 80 120" fill="currentColor" class="absolute top-10 right-0 z-0 w-32 text-yellow-500">
                            ...
                            <h1 class="text-3xl font-bold text-center text-teal-500 "><h1 class="py-2">Join ~ Build ~ Learn</h1><br/> <span class="text-blue-300">
                            Bring-out your hidden tech genius in this <text class="text-4xl font-bold text-blue-300">24</text> hours hackathon by solving difficult problems faced by the folks.
                            </span></h1>
    ...
    <div class="py-5">
                    ...
                    <div class="py-10">
                        <div class="flex justify-center space-x-10 m-10 font-semibold">
                            <div class="bg-teal-500 text-white px-8 py-2 rounded-md flex items-center space-x-2" href="re">
                                
                                <div class="flex">
                                    <span class="text-2xl text-slate-700 px-2 ">
                                        <img src={venue} height={50} width={50}/>
                                      </span>
                                    <span class="text-2xl text-slate-700 py-2">: Sairam Institutions </span>
                            ...
                            <a class="bg-teal-500 text-white px-8 py-2 rounded-md flex items-center space-x-2" href="re">
                                <span class="text-2xl text-slate-700 px-2 ">
                                    ...
                                    <span>
                                    <text class="text-2xl py-2 text-slate-800">: 2 ~ 4 per Team<br /></text> 
                                    </span>
                            ...
                            <a class="bg-teal-500 text-white px-4 py-2 rounded-md flex items-center space-x-2" href="re">
                                ...
                                <span><text class="text-2xl py-2 text-slate-800">: Free Registration<br /></text></span>
