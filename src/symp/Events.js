  ...
  return (
    <div id="events">
      <div class="bg-black">
        ...
        <br />
        <div class="events">
          <div className=" flex items-center px-28 py-10 justify-around">
            <div>
              <text class="text-xl font-nunito font-semibold text-white py-5">
                Technical Events
              </text>
              <a href="#technical">
        ...
        <div className="flex items-center justify-around px-28 py-10">
          <div className="card__container">
            <div className="card " data-aos="zoom-in">
              <div className="logo_container">
