...
class VFXPlayer {
                ...
                for (const e of this.elements) {
                    if (e.type === "text" && e.isInViewport) {
                        ...
                        if (rect.width !== e.width || rect.height !== e.height) {
                            yield this.rerenderTextElement(e);
                            e.width = rect.width;
    ...
    rerenderTextElement(e) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                e.element.style.setProperty("opacity", "1");
                const texture = e.uniforms["src"].value;
                const canvas = texture.image;
                yield dom_to_canvas_1.default(e.element, canvas);
    ...
    addElement(element, opts = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const elem = {
                ...
                isGif,
                overflow: (_b = opts.overflow) !== null && _b !== void 0 ? _b : false,
            };
